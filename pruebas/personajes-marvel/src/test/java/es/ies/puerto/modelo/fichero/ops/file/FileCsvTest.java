...
public class FileCsvTest {
    String nombreInsertar = "nameTest";
    String aliasInsertar = "aliasTest";
    String generoInsertar = "generoTest";
    List<String> poderesInsertar = new ArrayList<>(Arrays.asList("poder1Test", "poder2Test"));
